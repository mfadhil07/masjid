...
<head>
    <body>
        ...
        <form class="px-8 pt-6 pb-8 mb-4 bg-white rounded" method="POST" action="/login">
            ...
            <div class="p-4 mb-4 text-sm text-blue-700 bg-blue-100 rounded-lg dark:bg-blue-200
            dark:text-blue-800"
                role="alert">
              ...
              @csrf
                    ...
                    @enderror
						<div class="relative">
                            <button class="bg-blue-600 hover:bg-blue-900 text-white rounded-md px-2 py-1">Submit</button>
						</div>
					</div>
                    </form>
				</div>
