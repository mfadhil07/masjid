...
<script>
    let latLng = [5.14247252812, 96.6507201799];
    ...
    // const desa = urlParams.get('search')
    // let query = ''
    // if (desa != null) {
    //     query = `?search=${desa}`
    // }
        ...
        success: function (response) {
            const myLayer = L.geoJSON(response, {
                onEachFeature: function (feature, layer) {
                    ...
                    layer.bindPopup(
                        `<h1 class="text-sm"><b> <center> ${feature.properties.name}</center></b> Desa : ${feature.properties.desa}, Kec. ${feature.properties.kecamatan}</center></h1>`
                    )
                },
